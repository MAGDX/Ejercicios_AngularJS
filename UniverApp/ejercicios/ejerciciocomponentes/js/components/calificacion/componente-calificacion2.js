...
component('componenteCalificaciones', { // nombre componente => para usarlo <componente-calificaciones></componente-calificaciones>
  templateUrl: './ejercicios/ejerciciocomponentes/js/components/calificacion/template.html',
  bindings: {
    pnota: '@',
